...
(function($) {
    ...
    $(document).on("ready", function() {
        ...
        $('.page-node.node-type-product #bootstrap-fieldgroup-accordion--information .panel.group-information .panel-collapse').addClass('in').css('height', 'auto').attr('aria-expanded', 'true');
        $('.page-node.node-type-product #bootstrap-fieldgroup-accordion--information .panel.group-information .panel-title a').removeClass('collapsed').attr('aria-expanded', 'true');
    });
